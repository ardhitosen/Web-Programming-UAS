...
<body>
    ...
    <form action="/patients/forgotProcess" method="post" class="max-w-md mx-auto my-8 p-6 bg-white rounded shadow form-container">
        @if ($errors->any())
        ...
        <div class="mb-4">
            ...
            <input type="recovery_code" name="recovery_code" id="recovery_code"
                class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:border-blue-300">
        </div>


        <button type="submit"
            class="w-full bg-sky-500 text-white py-2 px-4 rounded hover:bg-blue-400 transition-colors">Submit</button>
    </form>
